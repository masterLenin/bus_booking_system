...
//             window.location.href =  "/searchBus/busDetails/"+this.state.from+"/"+this.state.to+"/"+this.props.currentLanguage
        }, 3000)
    }

    render(){
        var filterUrl = "/searchBus/busDetails/"+this.state.from+"/"+this.state.to
        return(
