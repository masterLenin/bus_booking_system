    ...
    render(){
        return(
            <div className="logInBg">
               ...
               <h1 className="fw-bolder" style={{color: 'red'}}><FormattedMessage  id="makeYourJourneyPleasant"/></h1>
                    ...
                    <div className="d-flex justify-content-between">
                        <div className="redbus1" >
                            <div className="d-flex offer1">
                                <input style={{width : "50%"}} value={this.state.offer1} readOnly/><button onClick={() => {navigator.clipboard.writeText(this.state.offer1)}}><i className='fa fa-copy'></i></button>
                            </div>
                        </div>
                        <div className="redbus2" >
                            <div className="d-flex offer1">
                                <input style={{width : "50%"}} value={this.state.offer2} readOnly/><button onClick={() => {navigator.clipboard.writeText(this.state.offer2)}}><i className='fa fa-copy'></i></button>
                            </div>
                        </div>
                        <div className="redbus3">
                            <div className="d-flex offer1">
                                <input style={{width : "50%"}} value={this.state.offer3} readOnly/><button onClick={() => {navigator.clipboard.writeText(this.state.offer3)}}><i className='fa fa-copy'></i></button>
                            </div>
                        </div>
                        <div className="redbus4">
                            <div className="d-flex offer1">
                                <input style={{width : "50%"}} value={this.state.offer4} readOnly/><button onClick={() => {navigator.clipboard.writeText(this.state.offer4)}}><i className='fa fa-copy'></i></button>
                            </div>
                        </div>
                    </div>
